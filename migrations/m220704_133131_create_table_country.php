...
/**
 * Class m220704_133131_create_table_country
 */
class m220704_133131_create_table_country extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    // {
    //     echo "m220704_133131_create_table_country cannot be reverted.\n";
    ...
    public function safeUp()
    {
        $this->createTable('countryInfo',[
            ...
            'lat' => $this->integer(45)->notNull(),
            'lang' => $this->integer(45)->notNull(),
        ...
        //     'lang' => '22'
        // ]);
        $this->batchInsert('countryInfo',
            ['id', 'code','name','phonecode','lat','lang'],[
